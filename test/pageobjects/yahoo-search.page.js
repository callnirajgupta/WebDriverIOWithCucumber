...
class YahooPage extends Page  {
  ...
  */
  ...
  get resultsresult()   { return $$('a[class=" ac-algo fz-l ac-21th lh-24"]'); }
  ...
  searchResultGetText(){
    console.log('size of search result',this.resultsresult.length);
    return this.resultsresult[1].getText();
  }
}
