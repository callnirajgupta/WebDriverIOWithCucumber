...
exports.config = {
  user: 'nirajgupta4',
  key: 'YigFP1LcnxRZpPTjBBxD',
    specs: [
        './test/features/yahoo-search.feature',   './test/features/ta-login.feature',
    ],
    // Patterns to exclude.
    exclude: [
    ...
    //tostart server seperatly use below command and comment abvove one
    //java -Dwebdriver.chrome.driver=chromedriverwin.exe -jar selenium-server-standalone-3.141.59.jar 
    ...
    cucumberOpts: {
        ...
        tagExpression: '@smoke',      // <string> (expression) only execute the features or scenarios with tags matching the expression, see https://docs.cucumber.io/tag-expressions/
